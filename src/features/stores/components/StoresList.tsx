    ...
    <div>
          ...
          <div key={store.storeId} className="card bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  className="btn btn-xs drawer-button mr-2"
                  onClick={() => handleOnClickUpdate(store.storeId)}
                >
                  editar
                </button>
                <button
                  className="btn btn-xs btn-error"
                  onClick={() => handleOnClickDelete(store.storeId)}
                >
                  eliminar
                </button>
              </div>
        ...
        <div className="modal-box">
          ...
          <div className="modal-action">
            <form method="dialog">
              ...
              <button ref={ref} className="btn btn-sm mr-2">
                Cancelar
              </button>
            </form>
            <button
      ...
      <div className="drawer drawer-end">
        ...
        <div className="drawer-side">
          ...
          ></label>
          <ul className="pt-20 p-4 w-2/6 min-h-full bg-base-100 text-base-content">
            <UpdateStore onCloseDrawer={handleCloseDrawer} />
          </ul>
        </div>
      </div>
    </div>
